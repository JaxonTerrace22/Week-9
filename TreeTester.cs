...
public static class TreesTester {
    ...
    public static void Run() {
        ...
        tree.Insert(1);
        tree.Insert(6);
        Console.WriteLine(tree.ToString()); // Expected: 1, 3, 4, 5, 6, 7, 10
        ...
        foreach (var value in tree.Reverse()) {
            Console.WriteLine(value); // Expected: 10, 7, 6, 5, 4, 3, 1
        }

        Console.WriteLine("\n=========== PROBLEM 4 TESTS ===========");
        Console.WriteLine(tree.GetHeight()); // Expected: 3
        tree.Insert(6);
        Console.WriteLine(tree.GetHeight()); // Expected: 3
        tree.Insert(12);
        Console.WriteLine(tree.GetHeight()); // Expected: 4
        ...
        Console.WriteLine(tree1.GetHeight()); // Expected: 3
        Console.WriteLine(tree2.GetHeight()); // Expected: 7 .. any higher and its not balanced
        Console.WriteLine(tree3.GetHeight()); // Expected: 8 .. any higher and its not balanced
        Console.WriteLine(tree4.GetHeight()); // Expected: 1
        Console.WriteLine(tree5.GetHeight()); // Expected: 0
    }
